...
const ReviewCard = (props) => {
  return (
    <div className=" flex flex-col w-full lg:w-2/6 bg-white p-3 rounded-lg gap-5 hover:scale-105 duration-100">
      <div className=" flex flex-row items-center lg:justify-start justify-center ">
        <div className="w-1/4">
        <img className=" rounded-full hover:scale-105 duration-100" src={props.img} alt="img" />
        </div>
        <div className=" mx-3">
          <h2 className=" font-semibold text-lg hover:scale-110 duration-100">{props.title}</h2>
