    ...
    <div className="fixed w-full z-10">
      <div>
        <div className=" flex flex-row justify-between p-5 lg:px-32 px-5 bg-gradient-to-r from-backgroundColor to-brightColor shadow-[0_3px_10px_rgb(0,0,0,0.2)]">
          <div className=" flex flex-row items-center cursor-pointer gap-2 hover:scale-110 duration-150">
            <span>
          ...
          <nav className="hidden md:flex flex-row items-center text-lg font-medium gap-8">
            <Link
              ...
              smooth={true}
              duration={500}
              className="group relative inline-block cursor-pointer hover:text-brightColor hover:scale-110 duration-150"
            >
              Home
