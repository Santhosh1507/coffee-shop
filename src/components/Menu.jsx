  ...
  return (
    <div className=" min-h-screen flex flex-col justify-center lg:px-32 px-5 bg-backgroundColor">
      ...
      <div className=" flex flex-wrap pb-8 gap-8 justify-center">
        <MenuCard img={img1} title="Espresso" value="$10"/>
        <MenuCard img={img2} title="Cappuccino" value="$15" />
        <MenuCard img={img3} title="Latte" value="$20" />
        <MenuCard img={img4} title="Americano" value="$30" />
        <MenuCard img={img5} title="Macchiato" value="$21" />
        <MenuCard img={img6} title="Doppio" value="$16" />
      </div>
    </div>
  );
};
